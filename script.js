...
var dateInputRef = document.querySelector("#dob-input");
var showBtnRef = document.querySelector("#palindrome__btn");
var resultRef = document.querySelector("#palindrome__ans");
